export default function AboutPage() {
  return (
    <article className="p-12 max-w-2xl">
      <h1 className="text-3xl font-light text-gray-900 mb-8">About Me</h1>

      <section className="mb-8">
        <h2 className="text-xl font-light text-gray-900 mb-4">Background</h2>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-light text-gray-900 mb-4">Interests</h2>
        <p className="text-sm text-gray-600 leading-relaxed">
      ...
      <section>
        <h2 className="text-xl font-light text-gray-900 mb-4">Timeline</h2>
        <ol className="space-y-3 text-sm text-gray-600">
          <li className="flex gap-4">
            <time dateTime="2022" className="flex-shrink-0 text-gray-500">2022</time>
            <span>Started exploring new creative directions</span>
          </li>
          <li className="flex gap-4">
            <time dateTime="2021" className="flex-shrink-0 text-gray-500">2021</time>
            <span>Expanded into videography and digital media</span>
          </li>
          <li className="flex gap-4">
            <time dateTime="2020" className="flex-shrink-0 text-gray-500">2020</time>
